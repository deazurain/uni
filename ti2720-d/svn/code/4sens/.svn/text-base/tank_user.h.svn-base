...
#define SENSOR_FL       (0xE0 >> 1) // front left sensor
#define SENSOR_FR       (0xE2 >> 1) // front right sensor
#define SENSOR_RL       (0xE4 >> 1) // rear left sensor
#define SENSOR_RR       (0xE6 >> 1) // rear right sensor
#define SENSOR_COMPASS  (0xC0 >> 1) // compas ?
